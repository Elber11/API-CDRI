...
app.add_url_rule('/clients/types/', view_func=client_type.client_type_r)
...
app.add_url_rule('/inventory-flow/types/', view_func=inventory_flow_type.inventory_flow_type_r)
